            ...
            (provided) => {
                return(
                    <div class="taskCard" {...provided.draggableProps} {...provided.dragHandleProps} ref={provided.innerRef} id={this.props.inputTask['id']}>
                        ...
                        <img onClick={this.deleteTask} class="deleteTaskIcon" src={del} alt="Delete Task" />
                    </div>
                )
            }
            }
       ...
       let list = this.props.inputList
        ...
        return(
            <div class="listContainer" id={this.props.id}>
                ...
                <img onClick={this.deleteList} class="deleteListIcon" src={del} alt="Delete List"/>
                </div>
                ...
                <div class="newListItem">
                    ...
                    <img class="addTaskIcon" onClick={this.addTask} src={submit} alt="Add Task"/>
                </div>
            </div>
        )
    }
...
class App extends React.Component{
    ...
    render = () => {
            return(
                ...
                <img src={plus}class="addListIcon" alt="Add Task" onClick={this.createList} />
                </div>
            )
    }
} 
